    ...
    return (
        <div className="max-w-6xl mx-auto p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="text-gray-500 text-sm font-medium">Interview Rate</div>
                                ...
                                {applications.map(app => (
                                    <tr key={app.id} onClick={() => navigate(`/application/${app.id}`)} className="hover:bg-gray-50 cursor-pointer transition">
                                        ...
                                        <td className="px-6 py-4 text-right flex items-center justify-end gap-2">
                                            ...
                                            <button onClick={(e) => handleDelete(app.id, e)} className="text-gray-400 hover:text-red-600 p-2" title="Delete Application"><Trash size={16} /></button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
