...
import { Plus, Trash2, ChevronRight, Check, UploadCloud, Loader2, FileText } from 'lucide-react';
...
const Onboarding: React.FC<Props> = ({ onComplete }) => {
  const [step, setStep] = useState(0); // 0 is upload, 1-4 are review/edit
    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      <div className="mb-8 text-center md:text-left">
        <h1 className="text-3xl font-bold text-gray-900">
          {step === 0 ? "Upload Your Resume" : "Review & Edit Profile"}
        </h1>
        <p className="text-gray-600 mt-2">
          {step === 0 
            ? "Upload your current PDF resume. Gemini will extract your details automatically." 
            : "Review the extracted data to ensure accuracy before generating applications."}
        </p>
      ...
      {step === 1 && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3 border border-blue-100">
             ...
             <div>
                <h4 className="font-semibold text-blue-900">Review Contact Details</h4>
                <p className="text-sm text-blue-700">AI might miss unique layouts. Please verify your contact info.</p>
             </div>
          </div>
